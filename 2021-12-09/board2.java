...
public class board2 extends JPanel implements ActionListener, Runnable {
    ...
    public void actionPerformed(ActionEvent e) {//loading the magazine
    	...
    	ArrayList magazine = guy.getShots(); //passes the whole arraylist to this class
...
///////////////////////////Collisions//////////////////////////////////////////////////////
    public void checkCollisions() {
    	Rectangle r1 = vil1.getBounds();//create a rectangle around enemy 1 and 2
    	Rectangle r2 = vil2.getBounds(); 
    	
    	ArrayList magazine = guy.getShots(); //We need to create a rectangle around every bullet we fire, so we repeat this code from above
    	for (int i = 0; i<magazine.size();i++) {
        	Weapon one = (Weapon) magazine.get(i); 		
        	
        	Rectangle one1 = one.getBounds();//gets the boundaries of each bullet fired
        	
        	if (r1.intersects(one1)  &&  vil1.alive == true) {//checks if they collide
        		vil1.alive = false;//makes everything un-alive
        		one.bVis = false;
        		System.out.println("You shot me!");
        	}
        	else if (r2.intersects(one1) && vil2.alive == true) {
        		vil2.alive = false;
        		one.bVis = false;
        		System.out.println("You shot me!");
        	}
        }
    	Rectangle g = guy.getBounds();
    	if (g.intersects(r1) && vil1.alive==true || g.intersects(r2) &&vil2.alive == true)
    		gameOver = true;
...
public void paint(Graphics g) {
  ...
  ///////////////////////////////////////////////Bullets/////////////////////////////////////////////////////////////////////////////
    ...
    if (guy.x>400)
    	...
    	if(guy.x > 500)//second spawned enemy
    		if(vil2.getAlive() == true)
...
//////////////////////////////////Jumping Mechanic///////////////////////////////////////////////////////////////////// 
    ...
    public void jumping() {
        ...
        if (up == false)//press jump? vel (y value decreases)
            guy.y--;//every instance of vel I have replaced it with guy.y
